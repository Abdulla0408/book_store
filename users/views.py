...
from .forms import LoginForm, RegisterForm, ProfileEditForm, ClientRegistrationForm, SelectRoleForm
...
class UsersListView(View):
    def get(self, request):
        ...
        return render(request, 'users/users_list.html', {'user': user})
...
class SelectRoleView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            form.save()
            return redirect('/')
        return render(request, 'users/select_role', {'form': form})
